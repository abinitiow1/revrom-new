...
const AllToursPage: React.FC<AllToursPageProps> = ({
  trips,
  onSelectTrip,
  onBookNow,
  onNavigateContact,
  ...
  return (
    <div className="bg-background dark:bg-dark-background min-h-screen">
      <SEOHead
        title="All Expeditions | Revrom.in"
        description="Explore all native-led motorcycle missions and tours through the Himalayas."
      />
      ...
      <section className="bg-slate-50 dark:bg-neutral-900 border-b border-border dark:border-dark-border py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-black font-display italic tracking-tighter uppercase mb-8">
              Expedition Catalog
            </h1>
            <p className="text-lg text-muted-foreground dark:text-dark-muted-foreground mb-12 leading-relaxed">
              Browse our full range of Himalayan missions. From technical passes to cultural sanctuaries,
            ...
            <div className="text-center py-32 space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Adjust your filters or search terms to find available deployments.
                </p>
              </div>
              <button
                type="button"
                onClick={onClearFilters}
                className="text-brand-primary font-black uppercase tracking-widest text-[11px] border border-brand-primary/20 px-6 py-3 rounded-xl hover:bg-brand-primary/5"
              >
                Reset All Intel Filters
              </button>
            </div>
          )}
        </div>
        ...
        <div className="bg-neutral-900 dark:bg-neutral-800 rounded-[3rem] p-8 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            ...
            <p className="text-white/60 font-medium">
              Our native scouts can design a specialized route just for your squad. Initialize a custom
              build today.
            </p>
          </div>
          <button
            ...
            className="relative z-10 bg-brand-primary text-white font-black uppercase tracking-widest text-xs px-10 py-5 rounded-2xl shadow-xl hover:scale-105 transition-transform"
          >
            Consult With Scouts
          </button>
